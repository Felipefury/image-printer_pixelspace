...
loadTemplates = function() {
    ...
    for (let i = 0; i < Object.keys(userTemplates).length; i++) {
        ...
        templates.push({
            "name": Object.keys(userTemplates)[i],
            "x": userTemplates[Object.keys(userTemplates)[i]].x,
            "y": userTemplates[Object.keys(userTemplates)[i]].y,
            "h": userTemplates[Object.keys(userTemplates)[i]].h,
            "w": userTemplates[Object.keys(userTemplates)[i]].w,
            "data": userTemplates[Object.keys(userTemplates)[i]].data,
            "alpha": userTemplates[Object.keys(userTemplates)[i]].alpha,
            "hidden": userTemplates[Object.keys(userTemplates)[i]].hidden,
            "move": userTemplates[Object.keys(userTemplates)[i]].move,
            "changed": false,
            "context": templateContext
        })
